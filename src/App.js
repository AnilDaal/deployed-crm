  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        <Route
          path="/"
          element={!isLoggedIn ? <CompanyPage /> : <Navigate to="/dashboard" />}
        />
        <Route
          path="/dashboard"
        ...
        <Route
          path="/admin-login"
          element={!isLoggedIn ? <AdminLogin /> : <Navigate to="/dashboard" />}
        />
        <Route
          path="/employee-login"
          element={
            !isLoggedIn ? <EmployeeLogin /> : <Navigate to="/dashboard" />
          }
        />
        <Route
          path="/projects"
          element={isLoggedIn ? <ProjectPage /> : <Navigate to="/" />}
        />
        ...
        <Route path="/customers">
          ...
          <Route
            path=":customerId"
            element={isLoggedIn ? <SingleCustomer /> : <Navigate to="/" />}
          />
          <Route
            path="new"
            element={isLoggedIn ? <NewCustomer /> : <Navigate to="/" />}
          />
          <Route
            path="edit/:customerId"
            element={isLoggedIn ? <EditCustomer /> : <Navigate to="/" />}
          />
        </Route>
        ...
        <Route path="/employees">
          <Route
            index
            element={isLoggedIn ? <EmployeePage /> : <Navigate to="/" />}
          />
          <Route
            path=":employeeId"
            element={isLoggedIn ? <Single /> : <Navigate to="/" />}
          />
          <Route
            path="new"
            element={isLoggedIn ? <New /> : <Navigate to="/" />}
          />
          <Route
            path="edit/:employeeId"
            element={isLoggedIn ? <Edit /> : <Navigate to="/" />}
          />
          <Route
            path=":employeeId/new-task"
            element={isLoggedIn ? <AddNewTask /> : <Navigate to="/" />}
          />
        </Route>
      </Routes>
      {/* 
